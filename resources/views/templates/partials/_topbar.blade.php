        ...
        <div class="navbar-header border-right">
            ...
            <a class="navbar-brand" href="{{ route('admin.index') }}">
                ...
                <b class="logo-icon">
                    ...
                    <!-- Dark Logo icon -->
                    <img src="{{ asset('assets/images/logos/sra.png') }}" alt="homepage" class="dark-logo"
                        width="50px" />
                    <!-- Light Logo icon -->
                    <h4 class="dark-logo"><b>SRA</b>.id</h4>
                    {{-- <img src="{{ asset('assets/images/logos/logo-light-icon.png') }}" alt="homepage"
                    class="light-logo" /> --}}
                </b>
                <!--End Logo icon -->
                <!-- Logo text -->
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle waves-effect waves-dark" href="" data-toggle="dropdown"
                        ...
                        <span class="ml-2 font-medium">
                            ...
                            {{ $rumahsakit = App\Models\RumahSakit::where('id_user', Auth::user()->id_user)->first()->nama_rs }}
                            @elseif( Auth::user()->role->role == 'Kepolisian')
                            {{ App\Models\Kepolisian::where('id_user', Auth::user()->id_user)->first()->nama_pl }}
                            @endif
                        </span><span class="fas fa-angle-down ml-2"></span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                        ...
                        <a class="dropdown-item" href="{{ route('profil/index') }}"><i class="ti-user mr-1 ml-1"></i> My
                            Profile</a>
